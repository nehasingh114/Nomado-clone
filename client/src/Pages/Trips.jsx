...
export const Trip = () => {
    ...
    const { auth: { isAuth, data }, trips: { trips } } = useSelector(store => store);
    ...
    return (
        <Box px={{ base: "10px", sm: "20px", lg: "50px", xl: "80px" }} py='20px'>
            {isAuth ? (<Box>
                ...
                <SimpleGrid columns={{ base: "1", md: "2", lg: "3" }} bg="#edf3f8" p={{ base: "10px", sm: "20px" }} mt='30px' spacing={{ base: "20px", md: "30px" }}>
                    {trips.map(ele => (
                ...
                <Box>
                    ...
                    <Text fontSize='13x' textAlign={'center'} color='gray.600' fontWeight={600} mt='20px'>
                    ...
                    <Box m='auto' w='fit-content' mt='20px'>
                        <Button colorScheme={'purple'} onClick={() => navigate('/signin')} w='240px'>
                            Sign In
                        </Button>
                    </Box>
                    <Text fontSize='13x' textAlign={'center'} color='gray.600' fontWeight={600} mt='10px'>
                        Or
                    </Text>
                    <Box m='auto' w='fit-content' mt='10px'>
                        <Button colorScheme={'purple'} onClick={() => navigate('/signup')} w='240px'>
