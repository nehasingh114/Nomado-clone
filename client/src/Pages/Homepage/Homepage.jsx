  ...
  return (
    <div>
      ...
      <Box className={style.mainbox}>
        ...
        <div>
          <Image className={style.image} src="https://forever.travel-assets.com/flex/flexmanager/images/2022/02/09/ORB_BrandPromise_Rewards_imgB_840x473_20220207.jpg?impolicy=fcrop&w=600&h=257&q=medium" />
        </div>

        <div>
          <Image className={style.image} src='https://forever.travel-assets.com/flex/flexmanager/images/2022/02/09/ORB_BrandPromise_InsiderPrices_imgB_840x473_20220207.jpg?impolicy=fcrop&w=600&h=257&q=medium' />
