...
<div className={style.box}>
    <div className={style.bigbox}>
        <Image className={style.bigimage} src="https://forever.travel-assets.com/flex/flexmanager/images/2021/03/25/ORB_FreeCancellation_lpheroB_1680x945_20210323.jpg?impolicy=fcrop&w=900&h=506&q=mediumHigh" />
     <div className={style.bgcolor}>
     <h2>Sunny days, flexiblle stays</h2>
        <h5 className={style.text}>you've waited a long time for this! Book your next trip now with free cancellation option.</h5> 
    </div>  
    </div>
    <div>
    <div className={style.smallbox}>
        <Image className={style.smallimage} src="https://forever.travel-assets.com/flex/flexmanager/images/2022/03/31/ORB_LGBTQ_2MenRunning_img_300x300_20220222.jpg?impolicy=fcrop&w=300&h=300&q=mediumHigh"/>
 <div>
 <h2>Travel as You Are</h2>
  <h5 className={style.text}>Find LGBTQ-welcoming hotels,travel ideas , Pride events, and more.</h5>
    </div>  
  </div>
    <div className={style.smallbox}>
        <Image className={style.smallimage} src='https://forever.travel-assets.com/flex/flexmanager/images/2021/08/23/ORB_MQ-TS_HU_164x152.jpg?impolicy=fcrop&w=300&h=300&q=mediumHigh'/>
     <div>
     <h2>Hotels under $99</h2>
<h5 className={style.text} >Choose from our inventory of select hotels all priced for $99 or less per night!</h5>
     </div>
     </div>
    </div>
</div>
...
<div className={style.hotels}>
  {hotels.map((el)=>(  <div className={style.divbox}>
      ...
      <h3 className={style.hotelrating}> <b > {el.rating}/5  </b>  <span> {el.reviews}  </span></h3>
      <div className={style.span}><div className={style.line}></div><span><Box  className={style.spanoff}>25% off</Box></span></div>
      <h5 className={style.refund}>Fully refundable option</h5>
<div className={style.price}> <h3 className={style.total}>${[el.price+el.total]}</h3><span><h3>${el.price}</h3></span> </div>
    </div>
  ))}
</div>
<br />
