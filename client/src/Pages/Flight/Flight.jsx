...
<Tabs>
  <TabList  className={style.TabList}>
    <Tab  _selected={{ backgroundColor:"#b2d8dd",color:"black"}}  className={style.tab}>RoundTrip</Tab>
    <Tab  _selected={{ backgroundColor:"#b2d8dd",color:"black"}}  className={style.tab}>One-Way</Tab>
    <Tab  _selected={{ backgroundColor:"#b2d8dd",color:"black"}}  className={style.tab}>Multi-City</Tab>
  </TabList>
...
<div className={style.box}>
    <div className={style.bigbox}>
        <Image className={style.bigimage} src="https://forever.travel-assets.com/flex/flexmanager/images/2021/01/25/ORB_FlexibleFligthDeals_lpheroB_1680x945_20201106.jpg?impolicy=fcrop&w=900&h=506&q=mediumHigh" />
     <div>
     <h2>Flights Under $199</h2>
        <h5 className={style.text}>Find fares under $199 with zero change fees.Book with confidence</h5> 
    </div>  
    </div>
    <div>
    <div className={style.smallbox}>
        <Image className={style.smallimage} src="https://forever.travel-assets.com/flex/flexmanager/images/2021/06/23/ORB_JetReset_lpheroB_1680x945_20210623.jpg?impolicy=fcrop&w=900&h=506&q=mediumHigh"/>
 <div>
 <h2>Jet and Reset</h2>
  <h5 className={style.text}>Hawaii,California,Florida - if there's sun and fun,there's flights for you.</h5>
    </div>  
  </div>
    <div className={style.smallbox}>
        <Image className={style.smallimage} src='https://c.stocksy.com/a/CLk400/z9/1131450.jpg?1552378045'/>
     <div>
     <h2>United Airlines Flights</h2>
<h5 className={style.text} >United Airlines has great fares to get you where you want to go.</h5>
     </div>
     </div>
    </div>
