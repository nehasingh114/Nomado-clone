import { Box, Flex, Heading, Text, Progress, ProgressLabel, Icon, Image, Button, Highlight } from '@chakra-ui/react';
...
export const ConfirmPayment = () => {
    ...
    const { auth: { data: userData }, singleHotel: { pictures } } = useSelector(store => store);
    ...
    return (
        <Box bg='gray.200' minH='100vh'>
            ...
            {loading ? (
                <Box px={{ base: "10px", sm: "20px", lg: "50px", xl: "80px" }} pt='10px'>
                    ...
                    <Box w='fit-content' m='30px auto'>
                        <Progress isIndeterminate colorScheme={'teal'} w='200px' borderRadius={'5px'}
                            h='20px'>
                            <ProgressLabel color={'black'} fontSize='16px'>Loading</ProgressLabel>
                        </Progress>
                    </Box>
                </Box>
            ) : (
                <Box px={{ base: "10px", sm: "20px", lg: "50px", xl: "80px" }} mt='30px'>
                    <Box p={{ base: "10px", sm: "20px" }} bg='white' borderRadius={'10px'}>
                        ...
                        <Flex gap={'20px'} bg='#edf2f8' p={{ base: "10px", sm: "20px" }} borderRadius={'10px'}
                            ...
                            <Box >
                                ...
                                <Text fontSize='13px' fontWeight={600} color='gray.600' mt='10px'>
                                    We have booked your spot for the selected date at the selected facility. Please arrive at the facility in due date and show the below Booking Number at the counter.
                                </Text>
                            </Box>
                        </Flex>

                        <Box bg='#edf2f8' p={{ base: "10px", sm: "20px" }} borderRadius={'10px'} mt='30px'>
                            <Text>
