...
import { MdBusinessCenter, MdFamilyRestroom, MdLocalConvenienceStore, MdLocalParking, MdRestaurantMenu } from 'react-icons/md';
        ...
        <>
            <Box bg='white' mt='40px' py='20px' px={{ base: "10px", md: "20px" }}>
                <SimpleGrid columns={{ base: 1, lg: 3 }} spacing={5}>
                    ...
                    <Box>
                        <Flex alignItems={'center'} gap='15px' mt={{ base: "0px", lg: "5px" }}>
                        ...
                        <Text fontSize='15px' mt='15px' pl='35px'>
                            Available in all rooms: Free WiFi and wired Internet<br />
                        ...
                        <Text fontSize='15px' mt='15px' pl='35px'>
                            Secured covered valet parking on site (USD 75 per day)<br />
                        ...
                        <Text fontSize='15px' mt='15px' pl='35px'>
                            Buffet breakfast available for a fee daily 6:30 AM–11:30 AM: USD 30 for adults and USD 30 for children<br />
                            1 restaurant<br />
                            1 bar<br />
