import { Modal, ModalOverlay, ModalCloseButton, ModalHeader, ModalBody, ModalContent, Box, Flex, Text, Image, Button } from "@chakra-ui/react"
            ...
            <ModalContent w='sm' m='auto'>
                ...
                <ModalBody>
                    <Flex justifyContent={'flex-end'} mt='20px' gap='15px'>
                        ...
                        <Button colorScheme='purple' fontSize='14px' onClick={() => {
                            modal.onClose();
                            navigate('/signin')
                        }}>SIGNIN
                        </Button>
