    ...
    return (
        <Box border='1px solid rgba(0,0,0,0.4)' bg='white' h='100%'>
            ...
            <Box p='10px' borderTop={'1px solid rgba(0,0,0,0.4)'} ref={containerRef}>
                ...
                <Text fontSize='15px'>
                    ${pictures.length && ((Number(hotelData['uitk-text 8'].substring(1)) + data.value + Number(value)) * rooms.length)} total
                </Text>
                <Portal containerRef={containerRef}>
                    <Flex justifyContent={'space-between'} alignItems='center'>
                        ...
                        {!data.sold ? <Button colorScheme='teal' h='35px' onClick={() => setRoom(data)}>
                            Reserve
                        </Button> : (
