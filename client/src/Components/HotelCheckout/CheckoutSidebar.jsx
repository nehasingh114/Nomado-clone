    ...
    return (
        <Box w={{ base: "100%", md: "35%" }} flexShrink={0}>
            <Box borderRadius={'5px'} bg='white'>
                <Box w='100%'>
                    <Image src={data['uitk-image-media src'] || data['uitk-image-media src 2'] || data['uitk-image-media src 3'] || data['uitk-image-media src 4'] || 'https://images.trvl-media.com/hotels/30000000/29060000/29051400/29051318/9b8d24be.jpg?impolicy=resizecrop&rw=455&ra=fit'} borderRadius='5px' />
                </Box>
                <Box py='20px' px='20px'>
