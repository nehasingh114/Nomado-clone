import {
    Modal, ModalOverlay, ModalCloseButton, ModalHeader, ModalBody, ModalContent, Box, Flex, Text,
    Image, Button
    ...
    return (
        <Modal isOpen={payModal.isOpen} onClose={payModal.onClose} m='0'>
            ...
            <ModalContent w='sm' m='auto'>
                ...
                <ModalCloseButton />
                <ModalBody>
                    <Flex justifyContent={'space-between'} alignItems='center' boxShadow={'inner'}
                        p='10px' borderRadius='10px' bg='#edf4f8'>
                        <Box>
                        ...
                        <Box w='50px' h='50px'>
                            <Image src='https://cdn-icons-png.flaticon.com/128/4140/4140048.png' alt='user' />
                        </Box>
                    </Flex>
