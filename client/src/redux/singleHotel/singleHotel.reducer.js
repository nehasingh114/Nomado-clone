import { ADD_ADULT, ADD_CHILDREN, CREATE_ROOM, REMOVE_ROOM, SET_CHECKIN, SET_CHECKOUT, SET_ROOMTYPE, SINGLE_HOTEL_ERROR, SINGLE_HOTEL_LOADING, SINGLE_HOTEL_PHOTOS, SINGLE_HOTEL_SUCCESS, SUB_ADULT, SUB_CHILDREN } from "./singleHotel.types";
let today = new Date();
